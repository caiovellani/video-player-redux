      ...
      <div className="flex w-[1100px] flex-col gap-6">
        ...
        <main className="relative flex overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900 shadow">
          ...
          <aside className="w-80 border-l border-zinc-800 bg-zinc-900">
            <div className="">
              <button className="w-full flex items-center gap-3 bg-zinc-800 p-4 cursor-pointer">
              ...
              <nav className="relative flex flex-col gap-4 p-6">
                <button className="flex hover:text-zinc-200 items-center gap-3 text-sm text-zinc-400 cursor-pointer">
